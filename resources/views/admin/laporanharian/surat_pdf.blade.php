...
<body>
    <div class="container">
        ...
        <div class="info-surat">
            ...
            <h5>Nomor : {{ $id_surat }}/HRD/LH/{{ $bulan }}/{{ $tahun }}</h5>
        </div>
        ...
        <div class="isi-surat">
            <div class="pembuka">
                <p>
                    Melaporan Kegiatan harian yang kami sebutkan berikut ini
                    :
                </p>
            </div>
            <table style="padding-left: 15px">
                ...
                <tr>
                    ...
                    <td style="padding-left:15px;padding-right:15px">:</td>
                    <td>{{ $jumlah_pekerjaan }}</td>
                </tr>
                <tr>
                    <td>Alat yang digunakan</td>
                    <td style="padding-left:15px;padding-right:15px">:</td>
                    <td>{{ $alat_digunakan }}</td>
                </tr>
            </table>
            ...
            <div class="penutup">
                <p>
                    Demikian surat ini Kami sampaikan</b>
                </p>
            </div>
        </div>
