...
<div class="page-header page-header-default">
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">edit Data Perencanaan</li>
        </ul>
    </div>
</div>
@endsection
...
<div class="panel bg-info">
    <div class="panel-heading">
        <em>
            <h6> Halaman ini berguna apabila anda ingin menambah data Laporan Perencanaan baru, pastikan data yang akan dieditkan
    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('perencanaan.update', $id) }}">
