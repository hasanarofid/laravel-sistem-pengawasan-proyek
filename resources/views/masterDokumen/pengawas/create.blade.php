...
@section('title', 'Tambah Data pengawas')
...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-users4"></i> <span class="text-semibold">Data pengawas</span>
                - Tambah Data pengawas</h4>
        </div>
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">Tambah Data pengawas</li>
        </ul>
    </div>
</div>
@endsection
...
<div class="panel bg-info">
    <div class="panel-heading">
        <em>
            <h6> Halaman ini berguna apabila anda ingin menambah data Laporan pengawas baru, pastikan data yang akan ditambahkan
...
<form method="post" enctype="multipart/form-data" action="{{ route('pengawas.store') }}">
