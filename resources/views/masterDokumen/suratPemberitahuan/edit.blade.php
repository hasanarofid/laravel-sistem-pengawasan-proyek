...
<div class="page-header page-header-default">
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-users4"></i> <span class="text-semibold">Data Surat Pemberitahuan</span>
                - edit Data Surat Pemberitahuan</h4>
        </div>
    ...
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">edit Data Surat Pemberitahuan</li>
        </ul>
    </div>
</div>
@endsection
...
<div class="panel bg-info">
    <div class="panel-heading">
        <em>
            <h6> Halaman ini berguna apabila anda ingin menambah data Laporan Surat Pemberitahuan baru, pastikan data yang akan dieditkan
    ...
    <form method="post" enctype="multipart/form-data" action="{{ route('suratPemberitahuan.update', $id) }}">
