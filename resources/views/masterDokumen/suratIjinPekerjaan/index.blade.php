...
@section('content')
    <div class="panel bg-info">
        <div class="panel-heading">
            <em>
                <h6>Pada halaman ini terdapat list daftar Surat Ijin Pekerjaan yang ada di dalam perusahaan ini. masing-masing
                    Time Shedule bisa
                    dihapus dan diedit.
                </h6>
            </em>
    ...
    <div class="panel panel-flat">
        <div class="panel-heading">
            <a href="{{ route('suratIjinPekerjaan.create') }}"><i class="icon-file-plus"></i> Tambah Data  </a>
        </div>
                                    ...
                                    <ul class="icons-list">
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="{{ route('suratIjinPekerjaan.destroy', $encyrpt) }}"><i
                                                            class=" icon-trash"></i> Hapus</a>
                                                </li>
                                                <li><a href="{{ route('suratIjinPekerjaan.edit', $encyrpt) }}"><i
