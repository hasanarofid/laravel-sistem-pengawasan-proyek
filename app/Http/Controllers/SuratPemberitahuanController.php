...
class SuratPemberitahuanController extends Controller
{
    ...
    public function index(){
        $laporan = MasterDokumen::where('type','suratPemberitahuan')->get();
        return view('masterDokumen.suratPemberitahuan.index', compact('laporan'));
    }

    // suratPemberitahuan add
    public function create(){
        return view('masterDokumen.suratPemberitahuan.create');
    }
    //suratPemberitahuan store
    public function store(Request $request){
        ...
        $masterdokumen->type = 'suratPemberitahuan';
        ...
        return redirect('suratPemberitahuan');
    }
    ...
    public function edit($data)
    {
        ...
        return view('masterDokumen.suratPemberitahuan.edit', [
            'id' => $data,
            'laporan' => $laporan,
        ]);
    }
    ...
    public function destroy($data)
    {
        ...
        return redirect(route('suratPemberitahuan'));
    }
}
