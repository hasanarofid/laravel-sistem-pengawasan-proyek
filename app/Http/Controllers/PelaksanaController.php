...
class PelaksanaController extends Controller
{
     ...
     public function index(){
         $laporan = MasterDokumen::where('type','pelaksana')->get();
         return view('masterDokumen.pelaksana.index', compact('laporan'));
     }
 
     // pelaksana add
     public function create(){
         return view('masterDokumen.pelaksana.create');
     }
     //pelaksana store
     ...
     public function edit($data)
     {
         ...
         return view('masterDokumen.pelaksana.edit', [
             'id' => $data,
             'laporan' => $laporan,
         ]);
     }
