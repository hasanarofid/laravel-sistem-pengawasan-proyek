...
class SuratUndanganRapatController extends Controller
{
    ...
    public function index(){
        $laporan = MasterDokumen::where('type','suratUndanganRapat')->get();
        return view('masterDokumen.suratUndanganRapat.index', compact('laporan'));
    }

    // suratUndanganRapat add
    public function create(){
        return view('masterDokumen.suratUndanganRapat.create');
    }
    //suratUndanganRapat store
    public function store(Request $request){
        ...
        $masterdokumen->type = 'suratUndanganRapat';
        ...
        return redirect('suratUndanganRapat');
    }
    ...
    public function edit($data)
    {
        ...
        return view('masterDokumen.suratUndanganRapat.edit', [
            'id' => $data,
            'laporan' => $laporan,
        ]);
    }
    ...
    public function destroy($data)
    {
        ...
        return redirect(route('suratUndanganRapat'));
    }
}
