...
class SuratIjinPekerjaanController extends Controller
{
    ...
    public function index(){
        $laporan = MasterDokumen::where('type','suratIjinPekerjaan')->get();
        return view('masterDokumen.suratIjinPekerjaan.index', compact('laporan'));
    }

    // suratIjinPekerjaan add
    public function create(){
        return view('masterDokumen.suratIjinPekerjaan.create');
    }
    //suratIjinPekerjaan store
    public function store(Request $request){
        ...
        $masterdokumen->type = 'suratIjinPekerjaan';
        ...
        return redirect('suratIjinPekerjaan');
    }
    ...
    public function edit($data)
    {
        ...
        return view('masterDokumen.suratIjinPekerjaan.edit', [
            'id' => $data,
            'laporan' => $laporan,
        ]);
    }
    ...
    public function destroy($data)
    {
        ...
        return redirect(route('suratIjinPekerjaan'));
    }
}
