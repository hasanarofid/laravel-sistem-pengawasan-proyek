...
class LaporanProgresController extends Controller
{
      ...
      public function index(){
          $laporan = MasterDokumen::where('type','laporanProgres')->get();
          return view('masterDokumen.laporanProgres.index', compact('laporan'));
      }
  
      // laporanProgres add
      public function create(){
          return view('masterDokumen.laporanProgres.create');
      }
      //laporanProgres store
      public function store(Request $request){
          ...
          $masterdokumen->type = 'laporanProgres';
          ...
          return redirect('laporanProgres');
      }
      ...
      public function edit($data)
      {
          ...
          return view('masterDokumen.laporanProgres.edit', [
              'id' => $data,
              'laporan' => $laporan,
          ]);
      }
      ...
      public function destroy($data)
      {
          ...
          return redirect(route('laporanProgres'));
      }
}
