...
class LaporanUmumController extends Controller
{
     ...
     public function index(){
         $laporan = MasterDokumen::where('type','laporanUmum')->get();
         return view('masterDokumen.laporanUmum.index', compact('laporan'));
     }
 
     // laporanUmum add
     public function create(){
         return view('masterDokumen.laporanUmum.create');
     }
     //laporanUmum store
     public function store(Request $request){
         ...
         $masterdokumen->type = 'laporanUmum';
     ...
     public function edit($data)
     {
         ...
         return view('masterDokumen.laporanUmum.edit', [
             'id' => $data,
             'laporan' => $laporan,
         ]);
     }
